...
import { useDeleteSuperHeroMutation, useUpdateSuperHeroMutation } from '@/redux/superheroes/superheroesApi'
                              ...
                              return (
                                             <div className="relative rounded-2xl bg-white/5 backdrop-blur border border-white/10 p-6 shadow-xl">
                                                            ...
                                                            <div className="mt-4 space-y-2 text-gray-300">
                                                                           ...
                                                                           <p><b>Powers:</b> {Array.isArray(hero.superpowers) ? hero.superpowers.join(', ') : hero.superpowers}</p>
                                                            </div>
                                                                           ...
                                                                           <Form className="space-y-4">
                                                                                          ...
                                                                                          <div>
                                                                                                         ...
                                                                                                         {errors.origin_description && touched.origin_description && (
                                                                                                                        <p className="text-red-500 text-sm mt-1">{errors.origin_description}</p>
                                                                                                         )}
                                                                                          </div>
                                                                                          ...
                                                                                          <div>
                                                                                                         ...
                                                                                                         <p className="text-sm text-gray-400 mt-1">
                                                                                                                        Enter powers separated by commas: Flight, Super strength, Heat vision
                                                                                                         </p>
